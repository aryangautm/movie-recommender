    ...
    <div className="relative h-screen font-sans text-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative overflow-hidden">
          ...
          {movie.backdropUrl && (
          <div
            className="absolute inset-0 w-full h-full bg-cover bg-center opacity-50 z-0"
          ...
          <div
          className="absolute inset-0 bg-gradient-to-b from-black/60 via-[#110E1B]/50 to-[#7D1AED]/10 z-10"
          />
